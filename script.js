...
const chatbotData = {
  welcome: "Welcome! How can I assist you with the project?",
  options: [
    { text: "What is this project about?", response: "This project is about creating a simple chatbot for your website." },
    { text: "Who is this project for?", response: "This project is designed for users who want to add interactive features to their site." },
    { text: "How does it work?", response: "The chatbot works by displaying options and responding to user selections." },
  ],
};
...
function displayOptions() {
  ...
  chatbotData.options.forEach((option) => {
...
function displayRestartButton() {
  ...
  restartButton.onclick = initializeChatbot;
  chatbotOptions.appendChild(restartButton);
}

function initializeChatbot() {
  chatbotMessages.innerHTML = "";
  displayMessage(chatbotData.welcome);
  displayOptions();
}
